...
void ShaderManager::CreateProgram(const std::string& programName, const std::string& vertexShaderFile, const std::string& fragmentShaderFile)
{
	//read the shader files and save the code
	std::string vertex_shader_code = ReadShader(vertexShaderFile);
	std::string fragment_shader_code = ReadShader(fragmentShaderFile);
